...
export default function K_Bahay_W3() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;K - BAHAY W3</b></h2>
                  <b><i>&nbsp;Jul-21-2022</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/K-Bahay W3_2022.png" target="_blank"><img src="/static/media/K-Bahay W3_2022.png" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
                  ...
                  <div>
                    <div className="box box-warning">
                      ...
                      <a href="/k_kalusugan_w3">
                        <h5 align="center"><b>K - KALUSUGAN W3</b></h5>
                      </a>
                      ...
                      <div className="box box-warning " style={{marginTop: '5%'}} />
                      <a href="/k_bahay_w2">
                        <h5 align="center"><b>K - BAHAY W2</b></h5>
                      </a>
                      <span><a href="/k_bahay_w2"><img src="/static/media/K-Bahay W2_2022.png" width="90%" style={{marginBottom: '2%', marginLeft: '5%'}} /></a></span>
                      <div className="box box-warning " style={{marginTop: '5%'}} />
                      {/* /.col */}
                    </div>
                    {/* /.row */}
