...
export default function K_Edukasyon_W1() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;K - EDUKASYON W1</b></h2>
                  <b><i>&nbsp;Sep-20-2021</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/K-EdukasyonSquareAds.jpg" target="_blank"><img src="/static/media/K-EdukasyonSquareAds.jpg" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
