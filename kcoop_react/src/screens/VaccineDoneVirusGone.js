...
export default function VaccineDoneVirusGone() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;Vaccine Done, Virus Gone</b></h2>
                  <b><i>&nbsp;Jun-11-2021</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/VaccineDone.jpg" target="_blank"><img src="/static/media/VaccineDone.jpg" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
