...
export default function K_Bahay_W2() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;K - BAHAY W2</b></h2>
                  <b><i>&nbsp;Jul-20-2022</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/K-Bahay W2_2022.png" target="_blank"><img src="/static/media/K-Bahay W2_2022.png" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
