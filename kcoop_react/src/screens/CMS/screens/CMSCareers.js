          ...
          {activeSlider.map((item)=>{return(
              <>
                <Td style={{padding: ".625em",textAlign: "center"}}>
                  ...
                  onClick={e=>DeleteButton(e, item.Careers_id)}>Delete</button>
                </Td>
              </>
            )}
          ...
          {notActiveSlider.map((item)=>{
            return(
              <Td style={{padding: ".625em",textAlign: "center"}}>
                <img src={item.Careers_image} style={{height: "115px", width: "180px"}}/>
                <br/>
                <button style={{backgroundColor: 'green', color:'white'}} onClick={e=>ActivateButton(e, item.Careers_id)}>Activate</button>
                <div style={{width:'20px',height:'auto',display:'inline-block'}}/>
                <button style={{backgroundColor: 'black', color:'white'}} onClick={e=>DeleteButton(e, item.Careers_id)}>Delete</button>
              </Td>
          )
          })}
        </Tr>
