...
const CMSK_Ganapan = () => {
  ...
  const updateSlider = (title,id, status) => {
    ...
    var headers = {
      ...
      //var pageTitle = "National Capital Region";
      var DataBody = {Stories_name: title, Stories_id: id, Stories_status: status, username: user[0].username, staff: user[0].Staff};
      //console.log("DATA BODY", JSON.stringify(DataBody));
      fetch(InsertAPIURL, {
        method: 'POST',
        headers: headers,
  ...
  const deleteSlider = (title,id) => {
    ...
    var headers = {
      ...
      //var pageTitle = "National Capital Region";
      var DataBody = {Stories_name: title, Stories_id: id, username: user[0].username, staff: user[0].Staff};
      //console.log("DATA BODY", JSON.stringify(DataBody));
      fetch(InsertAPIURL, {
        method: 'POST',
        headers: headers,
  ...
  const EditButton = (e, data)=>{
    ...
    */
    //navigate("edit/" + data);
    window.open("k_ganapan/edit/" + data, '_blank', 'noopener,noreferrer');
