...
const CMSOS = () => {
  ...
  const slideTitle = "ORGANIZATIONAL STRUCTURE";
  ...
  const updateSlider = (title,id, status) => {
    ...
    var headers = {
      ...
      //var pageTitle = "National Capital Region";
      var DataBody = {WhoWeAre_title: title, WhoWeAre_id: id, WhoWeAre_status: status, username: user.username, staff: staff};
      //console.log("DATA BODY", JSON.stringify(DataBody));
      fetch(InsertAPIURL, {
        method: 'POST',
        headers: headers,
  ...
  const deleteSlider = (title,id) => {
    ...
    var headers = {
      ...
      //var pageTitle = "National Capital Region";
      var DataBody = {WhoWeAre_title: title, WhoWeAre_id: id, username: user.username, staff: staff};
      //console.log("DATA BODY", JSON.stringify(DataBody));
      fetch(InsertAPIURL, {
        method: 'POST',
        headers: headers,
