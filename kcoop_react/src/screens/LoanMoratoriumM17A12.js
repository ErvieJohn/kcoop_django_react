...
export default function LoanMoratoriumM17A12() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;Loan Moratorium from March 17, 2020 to April 12, 2020</b></h2>
                  <b><i>&nbsp;Mar-17-2020</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/WALANG HULOG.jpg" target="_blank"><img src="/static/media/WALANG HULOG.jpg" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
