...
export default function Baro_Act_60DaysGracePeriod() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;BARO ACT - 60 DAYS GRACE PERIOD</b></h2>
                  <b><i>&nbsp;Oct-26-2020</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/BARO ANNOUNCEMENT.jpg" target="_blank"><img src="/static/media/BARO ANNOUNCEMENT.jpg" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
