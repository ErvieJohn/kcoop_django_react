                ...
                <div className="col-md-9">
                  ...
                  <div className="box box-warning " style={{marginTop: '-1.8%', marginBottom: '1%'}}>
                    <div className="box-header with-border">
                      <div className="col-md-1"><img src="/static/media/cross.jpg" width="50px" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                      <div className="col-md-8" style={{marginLeft: '0%', marginTop: '2%'}}>
                        <h3 className="box-title"><b>&nbsp;Health and Wellness
                          </b>
                        </h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww1.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww2.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww3.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww4.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww5.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/hww6.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  <div className="col-md-12" style={{marginBottom: '2%'}}><img src="/static/media/w7_2.jpg" width="100%" alt="Kabuhayan Sa Ganap Na Kasarinlan Credit And Savings Cooperative" /></div>
                  {/* /. box */}
                </div>
