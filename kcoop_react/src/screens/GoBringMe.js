...
export default function GoBringMe() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;Go Bring Me</b></h2>
                  <b><i>&nbsp;Jul-26-2022</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/GBM-Ads.png" target="_blank"><img src="/static/media/GBM-Ads.png" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
