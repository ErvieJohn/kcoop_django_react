...
export default function K_COOP3rdAnnualRA() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;K-COOP 3rd Annual R.A on March 27, 2020 is postponed</b></h2>
                  <b><i>&nbsp;Mar-12-2020</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/Announcement of Post-Poned.jpg" target="_blank"><img src="/static/media/Announcement of Post-Poned.jpg" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
