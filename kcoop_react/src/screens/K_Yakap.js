...
export default function K_Yakap() {
  return (
              ...
              <div className="row" style={{width: '98%', marginLeft: '1%'}}>
                ...
                <div className="col-md-9">
                  <h2><b>
                     ...
                     &nbsp;K - Yakap</b></h2>
                  <b><i>&nbsp;Jul-18-2022</i></b><br /><br />
                  <div className="box box-warning " />
                  <div className="col-md-12"><a href="/static/media/K-Yakap.png" target="_blank"><img src="/static/media/K-Yakap.png" width="100%" style={{marginBottom: '2%', marginLeft: '-1%'}} /></a></div>
