...
class TBL_Product(models.Model):
    ...
    Product_title = models.CharField(blank=True, default="", max_length=50)
    Product_status = models.CharField(null=True, blank=True, default="Active", max_length=50)
...
class MemberAuditTrail(models.Model):
    ...
    MemberAuditTrail_user = models.CharField(blank=True, default="", max_length=50)
    MemberAuditTrail_activity = models.CharField(blank=True, default="", max_length=255)
    MemberAuditTrail_action = models.CharField(blank=True, default="", max_length=50)
...
class AdminAuditTrail(models.Model):
    ...
    AdminAuditTrail_user = models.CharField(blank=True, default="", max_length=50)
    AdminAuditTrail_activity = models.CharField(blank=True, default="", max_length=255)
    AdminAuditTrail_action = models.CharField(blank=True, default="", max_length=50)
